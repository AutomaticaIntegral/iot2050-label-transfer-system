/**
 * Script para probar el comando CMD 10 (impresión estándar)
 * Cliente: Adisseo
...
// Función para enviar comando CMD 10 (impresión estándar)
function sendCmd10(messageId = 100) {
  return new Promise((resolve, reject) => {
    ...
    client.connect(PLC_PORT, PLC_HOST, () => {
      ...
      // Crear comando para impresión estándar
      const command = {
        cmd: 10, // CMD 10 para impresión estándar
        messageId: messageId,
...
// Ejecutar script
console.log('Iniciando prueba de CMD 10 (impresión estándar)...');
